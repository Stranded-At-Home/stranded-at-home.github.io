...
function createMaterials(){
     ...
     var imgTexture = new THREE.TextureLoader().load( "textures/purple.JPG" );
...
function loadModels() {
  ...
  loader.load( 'Models/amethyst_crystal.glb', gltf => onLoad( gltf, parrotPosition, newStandard), onProgress, onError );
